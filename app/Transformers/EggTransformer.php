...
class EggTransformer extends TransformerAbstract
{
    ...
    public function transform(Egg $egg)
    {
        ...
        return [
            ...
            'female_avatar' => (string) str_replace('bear.todev.ink', 'bear.yaqi.wang', $egg->female_avatar),
            'male_avatar'   => (string) str_replace('bear.todev.ink', 'bear.yaqi.wang', $egg->male_avatar ?? ''),
